...
// "essential" certificates are always visible. "more" certificates are
// collapsed under a "Show more" toggle to keep the section scannable.
export const certificates: Certificate[] = [
  ...
  },
  {
    ...
    hours: "35 hrs",
    description:
      "Covered Python fundamentals, generative AI foundations, building LLM applications with prompt engineering, and augmenting LLMs with RAG. Curriculum: Python Fundamentals (3h), AI For All: Basics to GenAI (3h), Generative AI Explained (3h), Building LLM Applications with Prompt Engineering (17h), Augment Your LLM Using RAG (9h).",
